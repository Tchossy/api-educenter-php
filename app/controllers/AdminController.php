...
class AdminController
{
  ...
  public function getAll()
  {
    ...
    if ($num > 0) {
      ...
      Response::send(200, array('error' => true, 'msg' => 'Nenhum administrador encontrado.'));
    }
  }
  ...
  public function searchByTerm()
  {
    ...
    if ($num > 0) {
      ...
      Response::send(200, array('error' => true, 'msg' => 'Nenhum administrador encontrado.', $admins_arr));
    }
  }
      ...
      if ($num_row > 0 && $email !== $row_email) {
        ...
        if (empty($first_name)) {
          ...
          if ($this->adminModel->update(
            ...
            Response::send(200, array('error' => false, 'msg' => 'Administrador atualizado com sucesso.'));
          } else {
  ...
  {
    Response::send(200, array('msg' => 'Erro: Ouve algum erro, tente novamente (rota: /admin).'));
  }
}